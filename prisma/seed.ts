...
const IDS = {
  ...
  subscriptions: { owner1: 'sub-owner1', owner2: 'sub-owner2' },
};
...
async function main() {
  ...
  // ── 2. Utilisateurs ────────────────────────────────────────────────────────
  const [admin, owner1, owner2, manager1, manager2, tUser1, tUser2, tUser3] =
    await Promise.all([
      prisma.user.upsert({
      ...
      prisma.user.upsert({
        ...
        create: {
          ...
          lastName: 'FOTSO',
          email: 'jeanpierre.fotso@immoplus.cm',
          phone: '+237677100001',
      ...
      prisma.user.upsert({
        ...
        create: {
          ...
          lastName: 'NDONGO',
          email: 'marieclaire.ndongo@immoplus.cm',
          phone: '+237677100002',
          passwordHash: await h('Owner@2024'),
          role: Role.OWNER,
          emailVerified: true,
      ...
      prisma.user.upsert({
        ...
        create: {
          firstName: 'Sophie',
          lastName: 'MBALLA',
          email: 'sophie.mballa@immoplus.cm',
          phone: '+237690200002',
          passwordHash: await h('Manager@2024'),
          role: Role.MANAGER,
          emailVerified: true,
      ...
      prisma.user.upsert({
        ...
        create: {
          firstName: 'Martin',
          lastName: 'ONDOA',
          email: 'martin.ondoa@immoplus.cm',
          phone: '+237655300003',
          passwordHash: await h('Tenant@2024'),
          role: Role.TENANT,
          emailVerified: true,
  ...
  await Promise.all([
    prisma.notificationPreference.upsert({
      ...
      create: {
        userId: admin.id,
        emailPrefs: { newUser: true, paymentAlert: true },
        smsPrefs: {},
      },
    }),
    prisma.notificationPreference.upsert({
    ...
    prisma.notificationPreference.upsert({
      ...
      create: {
        userId: owner2.id,
        emailPrefs: { paymentReceived: true, maintenance: true },
        smsPrefs: {},
      },
    }),
    prisma.paymentAlertConfig.upsert({
  ...
  const [prop1, prop2, prop3, prop4, prop5] = await Promise.all([
    ...
    prisma.property.upsert({
      where: { slug: 'appartement-3p-bastos-yaounde' },
      update: {},
      create: {
        ...
        floor: 2,
        description:
          'Bel appartement dans le quartier résidentiel de Bastos. Proche des ambassades, commerces et restaurants.',
        ownerId: owner1.id,
        isPublished: true,
      },
    }),
    ...
    prisma.property.upsert({
      where: { slug: 'villa-5ch-bonapriso-douala' },
      update: {},
      create: {
        ...
        floor: 0,
        description:
          'Magnifique villa avec piscine et jardin arboré dans le quartier huppé de Bonapriso. Idéale pour expatriés.',
        ownerId: owner1.id,
    ...
    prisma.property.upsert({
      where: { slug: 'bureau-80m2-akwa-douala' },
      update: {},
      create: {
        ...
        floor: 3,
        description:
          "Espace de bureau au 3ème étage, entièrement climatisé, avec salle de réunion et parking. Centre d'affaires Akwa.",
        ownerId: owner1.id,
        managerId: manager1.id,
        isPublished: true,
      },
    ...
    // Owner2 — Yaoundé
    prisma.property.upsert({
      where: { slug: 'appartement-2p-melen-yaounde' },
      update: {},
      create: {
        ...
        floor: 1,
        description:
          'Appartement fonctionnel et bien situé à Melen. Proche marché central et transports en commun.',
        ownerId: owner2.id,
        isPublished: true,
      },
    }),
    ...
    prisma.property.upsert({
      where: { slug: 'maison-4ch-makepe-douala' },
      update: {},
      create: {
        ...
        floor: 0,
        description:
          'Belle maison individuelle avec cour clôturée. Quartier calme et résidentiel de Makepe.',
        ownerId: owner2.id,
    ...
    prisma.contract.upsert({
      ...
      create: {
        ...
        clauses: {
          create: [
            {
              text: 'Le loyer est payable le 5 de chaque mois au plus tard.',
              order: 1,
            },
            {
              text: 'Toute dégradation du logement sera facturée au locataire.',
              order: 2,
            },
            {
              text: "Les charges d'eau et d'électricité sont à la charge du locataire.",
              order: 3,
            },
          ],
        },
    ...
    prisma.contract.upsert({
      ...
      create: {
        ...
        clauses: {
          create: [
            {
              text: "Le locataire est responsable de l'entretien de la piscine.",
              order: 1,
            },
            {
              text: 'Tout animal domestique est interdit dans la propriété.',
              order: 2,
            },
          ],
        },
  ...
  const rows: PayRow[] = [
    ...
    ...['2026-01', '2026-02', '2026-03', '2026-04'].map((m, i) => ({
      ...
      period: m,
      dueDate: `${m}-05`,
      paymentDate: `${m}-0${i + 1 > 4 ? 4 : i + 2}`,
      status: PaymentStatus.PAID,
      paymentMethod:
        i % 2 === 0 ? PaymentMethod.MOBILE_MONEY : PaymentMethod.TRANSFER,
    ...
    ...['2026-03', '2026-04', '2026-05'].map((m, i) => ({
      ...
      status: PaymentStatus.PAID,
      paymentMethod:
        i === 0 ? PaymentMethod.TRANSFER : PaymentMethod.MOBILE_MONEY,
    ...
    ...[
      ...
      period: m,
      dueDate: `${m}-05`,
      paymentDate: `${m}-0${(i % 4) + 1}`,
      status: PaymentStatus.PAID,
      paymentMethod:
        i % 3 === 0 ? PaymentMethod.TRANSFER : PaymentMethod.MOBILE_MONEY,
  ...
  await Promise.all([
    prisma.maintenanceRequest.upsert({
      ...
      create: {
        ...
        description:
          "Fuite sous le lavabo depuis 2 jours. L'eau coule en permanence et commence à humidifier le plancher.",
    ...
    prisma.maintenanceRequest.upsert({
      ...
      create: {
        ...
        description:
          'Le climatiseur principal du salon ne fonctionne plus depuis une semaine. Température insupportable.',
        urgency: MaintenanceUrgency.NORMAL,
        status: MaintenanceStatus.OPEN,
      },
    }),
    prisma.maintenanceRequest.upsert({
      where: { id: IDS.maintenance.m3 },
      update: {},
      create: {
        id: IDS.maintenance.m3,
        propertyId: prop4.id,
        tenantId: tenant2.id,
        title: "Serrure porte d'entrée défectueuse",
        description:
          "La serrure principale a du mal à s'ouvrir. Risque de rester bloqué à l'extérieur.",
        urgency: MaintenanceUrgency.HIGH,
  ...
  // ── 9. Plans & abonnements ─────────────────────────────────────────────────
  const [, professionalPlan] = await Promise.all([
    prisma.plan.upsert({
      where: { id: IDS.plans.starter },
      update: {},
      create: {
        id: IDS.plans.starter,
    ...
    prisma.plan.upsert({
      where: { id: IDS.plans.professional },
      update: {},
      create: {
        id: IDS.plans.professional,
    ...
    prisma.plan.upsert({
      where: { id: IDS.plans.enterprise },
      update: {},
      create: {
        id: IDS.plans.enterprise,
  ...
  // owner1/owner2 are seeded as standalone owners (no agency) — an active
  // (non-expiring) Professional subscription keeps the demo environment
  // functional without relying on a trial that will eventually expire.
  await Promise.all([
    prisma.subscription.upsert({
      where: { id: IDS.subscriptions.owner1 },
      update: {},
      create: {
        id: IDS.subscriptions.owner1,
        ownerId: owner1.id,
    ...
    prisma.subscription.upsert({
      where: { id: IDS.subscriptions.owner2 },
      update: {},
      create: {
        id: IDS.subscriptions.owner2,
        ownerId: owner2.id,
        planId: professionalPlan.id,
        status: SubscriptionStatus.ACTIVE,
      },
  ...
  console.log(
    '│ ADMIN       │ admin@immoplus.cm                        │ Admin@2024   │',
  );
  console.log(
    '│ OWNER       │ jeanpierre.fotso@immoplus.cm             │ Owner@2024   │',
  );
  console.log(
    '│ OWNER       │ marieclaire.ndongo@immoplus.cm           │ Owner@2024   │',
  );
  console.log(
    '│ MANAGER     │ paul.kamga@immoplus.cm                   │ Manager@2024 │',
  );
  console.log(
    '│ MANAGER     │ sophie.mballa@immoplus.cm                │ Manager@2024 │',
  );
  console.log(
    '│ TENANT      │ eric.nguema@immoplus.cm                  │ Tenant@2024  │',
  );
  console.log(
    '│ TENANT      │ alice.biya@immoplus.cm                   │ Tenant@2024  │',
  );
  console.log(
    '│ TENANT      │ martin.ondoa@immoplus.cm                 │ Tenant@2024  │',
  );
  console.log(
    '└─────────────┴──────────────────────────────────────────┴──────────────┘',
  );
